...
class SmoteExecutor(BaseExecutor):
    def __init__(self, config, data_loader):
        ...
        SmoteClass = self.config.model_config.SmoteClass
        SmoteClassConfig = self.config.model_config.SmoteClassConfig

        self.smote = globals()[SmoteClass](**SmoteClassConfig)
    ...
    def training_step(self, batch, batch_idx):
        ...
        sampled_features, sampled_labels = self.smote(
