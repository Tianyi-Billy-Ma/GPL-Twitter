...
local override = {
  ...
  experiment_name: 'oversampling_twitter_split_118',
  seed: seed,
  model_config: {
    base_model: 'OverSampling',
    OverSamplingClass: 'OverSampling',
    ModelClass: 'MLP',
    ModelClassConfig: {
      input_dim: 768,
      hidden_dim: 256,
      ...
      module_dict:
        {
          ...
          LoadDataLoader: {
            ...
            config: {
              train: [
                {
                  dataset_type: 'OverSampling_twitter',
                  split: 'train',
  ...
  train: {
    ...
    additional: {
      save_top_k_metric: 'valid/OverSampling_twitter.valid/f1_macro',
      save_top_k_mode: 'max',
